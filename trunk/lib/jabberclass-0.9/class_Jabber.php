...
class Jabber {
	...
	function connect($server_host,$server_port=5222,$connect_timeout=null,$alternate_ip=false) {
		...
		$connector = $this->_connector;
 		...
 		if (!$alternate_ip && class_exists('Net_DNS_Resolver', false)) {
	...
	function message($to, $type = "normal", $id = NULL, $body = NULL, $html = NULL, $subject = NULL, $payload = NULL, $raw = false) {
...
//			$subject = htmlspecialchars($subject);
			...
			if ($html)		$xml .= "<html xmlns='http://jabber.org/protocol/xhtml-im'><body xmlns='http://www.w3.org/1999/xhtml'>$rawBody</body></html>\n";
